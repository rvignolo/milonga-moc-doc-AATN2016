...
El proceso de \emph{ray tracing} sobre la geometría del problema a resolver es uno de los pasos más importantes que debe afrontarse en el método de las características. Luego de este procedimiento, se dispone de toda las estructuras de datos que almacenan la información de los \emph{tracks}: segmentos que los forman y la región a la que cada uno de ellos pertenece, condiciones de contorno.Como hemos visto, actualmente la implementación de MOC en milonga acepta únicamente dominios rectangulares. El motivo de esta limitación radica en que el tipo de algoritmo de \emph{ray tracing} desarrollado. 
