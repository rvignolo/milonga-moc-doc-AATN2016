...
\begin{figure}[!ht]
 \begin{center}
  \subfloat[\label{fig:cyclic-tracks-1}]{\includegraphics[width=0.485\linewidth]{graficos/cyclic-tracks/cyclic-tracks-1.pdf}} 
  \subfloat[\label{fig:cyclic-tracks-2}]{ \includegraphics[width=0.485\linewidth]{graficos/cyclic-tracks/cyclic-tracks-2.pdf}}\\
...
\begin{figure}[!ht]
 \begin{center}
  \subfloat[\label{fig:mesh-1}]{\includegraphics[width=0.479\linewidth]{graficos/meshes-and-segments/mesh-1.pdf}} 
  \subfloat[\label{fig:segments-1}]{ \includegraphics[width=0.501\linewidth]{graficos/meshes-and-segments/segments-1.pdf}}\\
...
\begin{figure}[!ht]
 \begin{center}
  \subfloat[\label{fig:mesh-2}]{\includegraphics[width=0.479\linewidth]{graficos/meshes-and-segments/mesh-2.pdf}}
  \subfloat[\label{fig:segments-2}]{ \includegraphics[width=0.501\linewidth]{graficos/meshes-and-segments/segments-2.pdf}}\\
